...
setup(
    ...
    url='https://git.skbkontur.ru/custom_dev/kontur_package_publisher',
    packages=find_namespace_packages(include=['kontur.*']),
    namespace_packages=['kontur'],
    entry_points={
        'console_scripts': ['publish=kontur.packagepublisher.api:publish'],
    },
